 ...
 */
final class Version20190321141830 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE posts_likes (post_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_FBCD156CA76ED395 (user_id), INDEX IDX_FBCD156C4B89032C (post_id), PRIMARY KEY(post_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
